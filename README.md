...
业务合约已部署并验证源码，测试网合约/API smoke 和本地双卖家联调通过；Web 构建与 lint 通过。测试网 API 验收使用同一钱包及独立卖家进程；完整浏览器钱包流程、Monad 双卖家验收及公网 Demo 尚未完成。当前结果、限制和交易证据统一见 [开发进度](docs/progress.md)。
