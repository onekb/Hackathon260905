...
For the MOJO form, use the actual market screenshot as the first screenshot/cover and the bill screenshot as the second; the overview can be added as supporting explanation. The generator commands below reproduce the original vector assets only and do not modify the real captures.
