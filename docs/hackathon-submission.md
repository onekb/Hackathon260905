...
最新浏览器两单后，根 15:58:23（Asia/Shanghai）只读确认卖家 normal/online/active0、原生订单 3、history15、全局剩 **6** 次、B 当日剩 **3** 次，epoch 不变；前段剩 8 为此前快照。B 可用 .0998342、授权剩 .0498342 MON，授权至 2026-09-06 15:52:32 +08。该轮证据与文档已在 fc9170f 通过 SSH 推送；后续 MOJO #385 已提交待审核。
