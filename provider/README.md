...
当前源码默认报价资产为原生测试 MON；新市场已部署，公网 Router a78470a 已切换、A 的 MON v1 报价与在线 2 槽回读通过。旧版 dUSD 在线记录和第二卖家交易保持历史身份，不能用旧市场报价自动在新市场接单；切换需新市场发布报价并重新认证。见 [当前进度](../docs/progress.md)。
